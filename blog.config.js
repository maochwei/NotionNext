...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '3fa35cb6a6cb4e29b38b7e9aaf7f7138',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Maochengzi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '社畜的日常', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.maochengzi.asia/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 技术', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jsrgmcw@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK: process.env.NEXT_PUBLIC_WIDGET_PET_LINK || 'https://cdn.jsdelivr.net/npm/live2d-widget-model-nico@1.0.5/assets/nico.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_AUDIO_LIST: [ // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=28302848.mp3',
      cover: 'http://p2.music.126.net/k6jxqMX4gHH1vkaUlt1lAQ==/3432675305537587.jpg'
    },
    {
      name: 'you & i',
      artist: 'Falcom Sound Team jdk',
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '9cc56ebe8129fa15d479dc0e44016396', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
